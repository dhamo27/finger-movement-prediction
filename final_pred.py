...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:\\Users\\saran\\Desktop\\Sign-Language-To-Text-and-Speech-Conversion-master\\cnn8grps_rad1_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("A Framework For Predicting Finger Movement")
        ...
        self.T.config(text="A Framework For Predicting Finger Movement", font=("Courier", 30, "bold"))
    ...
    def video_loop(self):
        try:
            ...
            if hands[0]:
                ...
                white = cv2.imread("C:\\Users\\saran\\Desktop\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
    ...
    def predict(self, test_image):
        ...
        if len(self.str.strip())!=0:
            ...
            if len(word.strip())!=0:
                # ddd.check(word)
                lenn = len(spell.correction(word))
                if lenn >= 4:
                    self.word4 = spell.correction(word)[3]

                if lenn >= 3:
                    self.word3 = spell.correction(word)[2]

                if lenn >= 2:
                    self.word2 = spell.correction(word)[1]

                if lenn >= 1:
                    self.word1 = spell.correction(word)[0]
            else:
                self.word1 = " "
                self.word2 = " "
                self.word3 = " "
